...
export default function App() {
    const setBasePrice = roiStore((state) => state.setBasePrice);
    const setSellPrice = roiStore((state) => state.setSellPrice);
    const setQuantity = roiStore((state) => state.setQuantity);
    ...
    const { basePrice, sellPrice, quantity} = roiStore();
    return (
